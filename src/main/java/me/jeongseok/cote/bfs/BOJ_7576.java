...
public class BOJ_7576 {
    public static void main(String[] args) throws IOException {
        ...
        while (!queue.isEmpty()) {
            Pair currentTomatoLocation = queue.poll();
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (tomatoes[newX][newY] == -1 || dates[newX][newY] != -1) {
                    continue;
                }

                queue.offer(new Pair(newX, newY));
                dates[newX][newY] = dates[currentTomatoLocation.getX()][currentTomatoLocation.getY()] + 1;
            }
        }
